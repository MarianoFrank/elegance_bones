...
document.addEventListener("DOMContentLoaded", function () {
  ...
  contenedoresRating.forEach(contenedorRating => {
    const rating = parseFloat(contenedorRating.querySelector(".rating").textContent);
    console.log(rating);
  ...
  const rellenarEstrellasHastaSeleccionada = valorEstrella => {
    for (let i = 1; i <= valorEstrella; i++) {
      const estrella_i = document.querySelector(`.stars-selector i[data-value="${i}"]`);
...
/******/ })()
;
//# sourceMappingURL=starsRating.min.js.map