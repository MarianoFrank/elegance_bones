...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const integrarClasesSwiper = () => {
    const contenedoresPricipales = document.querySelectorAll("section div.woocommerce");
    contenedoresPricipales.forEach(contenedorPricipal => {
      ...
      const productsContainers = contenedorPricipal.querySelectorAll("ul.products"); //wrapper
  ...
  const crearSwipers = () => {
    for (let i = 0; i < contadorSwipers; i++) {
      new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](`.swiper-container-${i}`, argSwiper);
    }
  };
  const argSwiper = {
    slidesPerView: 1,
